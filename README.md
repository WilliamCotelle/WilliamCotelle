...
<a href="https://william-cotelle.vercel.app/"><img src="https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=vercel&logoColor=white&labelColor=000000" alt="Portfolio" /></a>
<a href="https://www.linkedin.com/in/william-cotelle-528897251/"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white&labelColor=0A66C2" alt="LinkedIn" /></a>
<a href="mailto:williamcotellegaa@gmail.com"><img src="https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white&labelColor=EA4335" alt="Email" /></a>
...
`Agile` · `TDD` · `CI/CD` · `Monorepo` · `RLS`

---

## LSDT · plateforme de coaching sportif

Je porte l'ensemble du périmètre technique du produit, du mobile à la base de données. Une stack TypeScript de bout en bout, des paiements multi-comptes via Stripe Connect, et une architecture pensée pour la fiabilité.
...
> Parcours d'abonnement engagé, packs de séances, achats one-shot, authentification OAuth Google et Apple via pattern de relais backend, notifications push.

**Site web** · Next.js
> Vitrine du produit et tunnel de conversion, intégré au même écosystème que l'app.

**Backoffice** · interface d'administration
> Pilotage des coachs, des comptes connectés Stripe, des programmes et des abonnements. Gestion des modes opératoires et du cycle de vie des offres.

**Backend / API** · Node.js + Express + TypeScript
> API REST typée, logique de facturation Stripe Connect (charges directes, abonnements verrouillés par compte connecté), crons quotidiens, gestion des cas de concurrence sur les achats.

**Base de données** · Supabase + PostgreSQL + Prisma
> Modélisation du schéma, migrations versionnées appliquées manuellement, sécurité au niveau ligne. Backend mergé avant le mobile, commits atomiques.
...
<img src="https://github-readme-streak-stats.herokuapp.com/?user=WilliamCotelle&hide_border=true&background=141D2B&stroke=58A6FF&ring=9FEF00&fire=9FEF00&currStreakLabel=58A6FF&sideLabels=C9D1D9&dates=8B949E&sideNums=C9D1D9&currStreakNum=C9D1D9" alt="streak" />
...
![Français](https://img.shields.io/badge/Français-natif-58A6FF?style=for-the-badge&labelColor=141D2B)
![Anglais](https://img.shields.io/badge/Anglais-B1-C9D1D9?style=for-the-badge&labelColor=141D2B)

<div align="center">

<img src="https://capsule-render.vercel.app/api?type=rect&color=0:141D2B,100:0D1117&height=60&section=footer" width="100%" />
